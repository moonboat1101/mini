...
export const scriptGames = [
  {
    name: "芥子：弥望之川",
    time: "2026.5",
    desc: '在那弥望山岭深处，有一座村子名唤"弥岭村"。村前有一条大河，是为"须陀河"。据传，这弥岭村乃是由数百年前一支战败的明军所建立。他们为了躲避清军追捕而误入此地，却再也没能离开，只能在那松柏山头，日夜远望回不去的故乡。直到某日，从那须陀河里走出来一位菩萨。村民问菩萨要去往何处？菩萨曰：须弥山巅六欲天。村民请求菩萨带他们一起离开，菩萨摇了摇头。村民又问那他们该去往何处？菩萨答：你们当入无间地狱，历千万亿劫，求出无期…诡语系列终章上部，8人（4男4女）独家硬核推理本，延续《弥留》《须臾》的中式变格风格，注重诡计与推凶，短小精悍的文字体量却能让推土机原地奋斗八小时，包含大量前作彩蛋与破壁玩法。',
    score: 4.5,
    img: "https://kimi-web-img.moonshot.cn/img/img.alicdn.com/2a679efcdb97a50d6e23f400f6ba4dd2edf3b5dd.jpg",
    comment:
      "我是王阳，非常非常高质量的一个推理还原本，逻辑非常缜密，在有限的线索中一直发现新的问题，还可以一直解决，安美纳斯之下第一！",
